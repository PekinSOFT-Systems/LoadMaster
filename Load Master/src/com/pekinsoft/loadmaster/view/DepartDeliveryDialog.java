 ...
 * *****************************************************************************
 *  Project    :   Load_Master
 *  Class      :   DepartDeliveryDialog.java
 *  Author     :   Sean Carrick
 *  Created    :   Sep 13, 2020 @ 4:24:07 PM
...
public class DepartDeliveryDialog extends javax.swing.JDialog {
     ...
     */
    public DepartDeliveryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DepartDeliveryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DepartDeliveryDialog dialog = new DepartDeliveryDialog(new javax.swing.JFrame(), true);
