 ...
 *                                    in and that all provided data is valid.
 * *****************************************************************************
 */
 ...
 * @author Sean Carrick
 */
public class BrokerEntryForm extends javax.swing.JInternalFrame {
     ...
     */
    public BrokerEntryForm() {
        lr = new LogRecord(Level.ALL, "Logging initialized for Customers.");
        lr.setSourceClassName(BrokerEntryForm.class.getName());
