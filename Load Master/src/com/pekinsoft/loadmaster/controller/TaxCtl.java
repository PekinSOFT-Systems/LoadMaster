...
import com.pekinsoft.loadmaster.model.TaxModel;
 ...
 * @since 0.1.0
 */
public class TaxCtl extends AbstractJournal<TaxModel> {

    //<editor-fold defaultstate="collapsed" desc="Constructor(s)">
    public TaxCtl () throws DataStoreException {
        super(new TaxModel(), Starter.props.getDataFolder() 
                + TaxModel.ACCOUNT_NUMBER + ".jrnl");
    }
    //</editor-fold>
    ...
    @Override
    protected String createTableRecord(TaxModel model) {
        // Place implementation code here...
        /* ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ REMOVE ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ */
        throw new UnsupportedOperationException("Not supported yet."); /*<--*/
        /* ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ REMOVE ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ */
