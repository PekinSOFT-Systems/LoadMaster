...
import com.pekinsoft.loadmaster.model.SuppliesModel;
 ...
 * @since 0.1.0
 */
public class Supplies extends AbstractJournal<SuppliesModel> {

    //<editor-fold defaultstate="collapsed" desc="Constructor(s)">
    public Supplies () throws DataStoreException {
        super(new SuppliesModel(), Starter.props.getDataFolder() 
                + SuppliesModel.ACCOUNT_NUMBER + ".jrnl");
    }
    //</editor-fold>
    ...
    @Override
    protected String createTableRecord(SuppliesModel model) {
        // Place implementation code here...
        /* ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ REMOVE ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ */
        throw new UnsupportedOperationException("Not supported yet."); /*<--*/
        /* ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ REMOVE ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ */
