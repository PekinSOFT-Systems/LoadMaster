...
import com.pekinsoft.loadmaster.model.TollsModel;
 ...
 * @since 0.1.0
 */
public class TollsCtl extends AbstractJournal<TollsModel> {

    //<editor-fold defaultstate="collapsed" desc="Constructor(s)">
    public TollsCtl () throws DataStoreException {
        super(new TollsModel(), Starter.props.getDataFolder() 
                + TollsModel.ACCOUNT_NUMBER + ".jrnl");
    }
    //</editor-fold>
    ...
    @Override
    protected String createTableRecord(TollsModel model) {
        // Place implementation code here...
        /* ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ REMOVE ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ */
        throw new UnsupportedOperationException("Not supported yet."); /*<--*/
        /* ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ REMOVE ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ */
