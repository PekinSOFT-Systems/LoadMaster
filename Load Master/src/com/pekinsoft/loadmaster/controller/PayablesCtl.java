...
import com.pekinsoft.loadmaster.model.PayablesModel;
 ...
 * @since 0.1.0
 */
public class PayablesCtl extends AbstractJournal<PayablesModel> {

    //<editor-fold defaultstate="collapsed" desc="Constructor(s)">
    public PayablesCtl () throws DataStoreException {
        super(new PayablesModel(), Starter.props.getDataFolder() 
                + PayablesModel.ACCOUNT_NUMBER + ".jrnl");
    }
    //</editor-fold>
    ...
    @Override
    protected String createTableRecord(PayablesModel model) {
        // Place implementation code here...
        /* ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ REMOVE ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ */
        throw new UnsupportedOperationException("Not supported yet."); /*<--*/
        /* ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ REMOVE ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ */
