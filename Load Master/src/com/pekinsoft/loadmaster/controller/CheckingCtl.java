...
import com.pekinsoft.loadmaster.model.CheckingModel;
 ...
 * @since 0.1.0
 */
public class CheckingCtl extends AbstractJournal<CheckingModel> {

    //<editor-fold defaultstate="collapsed" desc="Constructor(s)">
    public CheckingCtl () throws DataStoreException {
        super(new CheckingModel(), Starter.props.getDataFolder() 
                + CheckingModel.ACCOUNT_NUMBER + ".jrnl");
    }
    //</editor-fold>
    ...
    @Override
    protected String createTableRecord(CheckingModel model) {
        // Place implementation code here...
        /* ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ REMOVE ⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩⇩ */
        throw new UnsupportedOperationException("Not supported yet."); /*<--*/
        /* ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ REMOVE ⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧⇧ */
