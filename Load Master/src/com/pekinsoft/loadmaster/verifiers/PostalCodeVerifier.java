...
import com.pekinsoft.loadmaster.view.CustomerEntry;
    ...
    public boolean verify(JComponent input) {
        ...
        if ( zipCode != null && !zipCode.isEmpty() && !zipCode.isBlank() 
            ...
            if ( isValid ) {
                ...
                CustomerEntry.helpPanel.setBackground(ctl);
                CustomerEntry.helpLabel.setText("");
            } else {
                ((JTextField) input).setBackground(errBack);
                ((JTextField) input).setForeground(errFore);
                CustomerEntry.helpPanel.setBackground(Color.RED);
                CustomerEntry.helpLabel.setText("Zip Code is required and must be a "
