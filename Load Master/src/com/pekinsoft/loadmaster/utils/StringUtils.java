...
public class StringUtils {
     ...
     *
     * Specifically: * If the number of characters in `source` is less than or
     * equal to `maxLength, return `source`. * Else abbreviate it to
     * (`substring(source, maxLangth - 3) + "..."`). * If `width` is less than
     * four, throw and `IllegalArgumentException`. * In no case will it return a
     * String of length greater than `width`.
     *
     * ```java StringUtils.abbreviate(null, *) = null StringUtils.abbreviate("",
     * 4) = "" StringUtils.abbreviate(abcdefg, 6) = "abc..."
     ...
     *
     * ```java StringUtils.deleteWhitespace(null) = null
     * StringUtils.deleteWhitespace("") = "" StringUtils.deleteWhitespace("abc")
     * = "abc" StringUtils.deleteWhitespace(" ab c ") = "abc"
     *
